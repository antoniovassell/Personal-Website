...
<head>
	...
	<meta name="description" content="<?php echo $this->fetch('page_description', __('Learn more about me as a CakePHP Web Developer and my love for Machine Learning, catch up with my applications')); ?>">
