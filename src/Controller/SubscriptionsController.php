...
class SubscriptionsController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Subscriptions->save($subscription)) {
                $this->Flash->success('The subscription has been saved.');
                return $this->redirect(['action' => 'index']);
            } else {
                $this->Flash->error('The subscription could not be saved. Please, try again.');
            }
        }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Subscriptions->delete($subscription)) {
            $this->Flash->success('The subscription has been deleted.');
        } else {
            $this->Flash->error('The subscription could not be deleted. Please, try again.');
        }
        return $this->redirect(['action' => 'index']);
    }
}
